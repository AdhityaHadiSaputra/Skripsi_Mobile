...
class StopwatchIsolateImpl extends StopwatchIsolate {
  ...
  Future<Isolate> createIsolate(
    ...
    printStopwatchIsolate('create stopwatch isolate');
  ...
  void sendDataToMainPort(SendPort sendPort, dynamic data) {
    printStopwatchIsolate('sendDataToMainPort stopwatch $data');
    sendPort.send(data);
  }
  ...
  Future<void> close(Isolate isolate) async {
    ...
    printStopwatchIsolate('isolate stopwatch destroyed $isolate');
  }
